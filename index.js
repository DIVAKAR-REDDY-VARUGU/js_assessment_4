...
body.innerHTML=`<section id='section-wraper'>
        ...
        <div class='right-side-wrapper'>
            <div class='right-side-content'>
                <h1 class='content-main-heading'>Men Navy Blue Solid Sweatshirt</h1>
                <h4 class='brand-title'>United Colors of Benetton</h4>
                <h3 class="product-price">Price: Rs <span>2599</span></h3>
                <div class='product-description-wrapper'>
                    <h3 class="product-description-title" >Description</h3>
                    <p class="product-description">Navy solid sweatshirt with patchwork, has a round neck, long sleeves, straight hem</p>
                </div>
